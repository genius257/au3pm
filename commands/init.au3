Global $packagePath = StringFormat("%s\au3pm.json", @WorkingDir)
...
$name = ConsoleReadLineSync()

ConsoleWrite("version: ")
$version = ConsoleReadLineSync()
If $version == "" Then $version = "1.0.0"

ConsoleWrite("description: ")
$description = ConsoleReadLineSync()

ConsoleWrite("main file: ")
$main = ConsoleReadLineSync()
